...
public class CadastroProduto extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(comboFornecedor, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
    ...
    private void comboProdutoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboProdutoItemStateChanged
		...
		if (evt.getStateChange() == ItemEvent.SELECTED) {
			...
			insereValoresCombo(produto.getFornecedores());
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
		...
		insereValoresCombo(textoFornecedor);
	...
	private void insereValoresCombo(String texto) {
		if (texto.indexOf(',') < 0) {
			comboFornecedor.removeAllItems();
		} else {
			String[] fornecedores = texto.split(",");
			int tamanho = fornecedores.length;

			comboFornecedor.removeAllItems();
			for (int i = 1; i < tamanho; i++) {
				comboFornecedor.addItem(fornecedores[i - 1]);
			}
		}
	}
